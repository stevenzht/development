...
/**
 * 一、Map的实现类的结构
 * ----Map：双列数据，存储key-vale对的数据  ----类似于高中的函数：y = f(x)
 ...
 * 3.CurrentHashMap 与 HashMap的异同？（暂时不讲）
 *
 * 二、Map结构的理解
 *  Map中的kay：无序的，不可重复的，使用Set存储所有的key    ----key所在的类要重写equals()和hashCode()(以HashMap为例)
