...
public class BookDaoTest {
    ...
    public void queryForPageItems() {
        for (Book book:bookDao.queryForPageItems(8, Page.getPageSize())){
    ...
    public void queryForPageItemsByprice() {
        for (Book book:bookDao.queryForPageItemsByPrice(0, Page.getPageSize(),10,50)){
            System.out.println(book);
        }
    }
}
